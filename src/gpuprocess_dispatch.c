...
{
    // We should always load dispatch_glx_entries first
    gpuprocess_dispatch_init_entries(dispatch, dispatch_glx_entries, DLSYM);
    gpuprocess_dispatch_init_entries(dispatch, dispatch_opengl_entries, GLXGETPROC);
}
